...
However, for developers just starting on Ethereum or users who don't have easy access (or knowledge) of an Ethereum node, you can use an Ethereum gateway service called [Infura.](https://infura.io)
...
Follow the steps below to sign up for Infura (there are also great step-by-step instructions on Infura's website [here](https://blog.infura.io/getting-started-with-infura-28e41844cc89/)):

## Register

First thing, register for a free account on [Infura.](https://infura.io) For smaller development projects (or even medium-sized ones), Infura's free tier is more than capable of handling your requests. Coogan is currently running an Eth2 validator client on Infura's free tier (you'll see it in the screenshots below!)
...
[source](https://ethereum.stackexchange.com/questions/96929/infura-io-secret-configuration-in-hdwalletprovider-truffle-config-js)
...
(For reference, in the above snippet we're also using Truffle’s [HDWalletProvider library](https://github.com/trufflesuite/truffle/tree/develop/packages/hdwallet-provider) enabling us to use a custom mnemonic as part of the deployment.) 
